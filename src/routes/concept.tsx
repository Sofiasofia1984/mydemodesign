...
const concepts: Concept[] = [
  ...
  { size: 4, cat: "E-commerce · Skincare", yr: "'26", title: "Velvet Skin Co.", desc: "Negozio online per skincare clean. Schede prodotto editoriali, ingredienti come protagonisti, check-out a un solo passo.", tags: ["WooCommerce", "Editoriale"], img: "https://images.unsplash.com/photo-1570194065650-d99fb4bedf0a?w=900&q=80&auto=format&fit=crop" },
  ...
  { size: 6, cat: "Professioniste · Consulenza", yr: "'25", title: "Giulia Ferri Studio.", desc: "Personal brand per una consulente fiscale specializzata in liberi professionisti del beauty. Tono serio, ma caldo. Prenotazione integrata.", tags: ["Personal brand", "Booking"], img: "https://images.unsplash.com/photo-1573496546620-c449b3aaf5c9?w=1200&q=80&auto=format&fit=crop" },
